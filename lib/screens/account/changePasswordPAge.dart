      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            SizedBox(width: 10,),
            Text(getTransrlate(context, 'changePassword'),style: TextStyle(color: Colors.white),),
          ],
        ),
      ),
      body: Padding(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: ()  {
                          if (_formKey.currentState.validate()) {
                            ...
                            API(context).post('user/${pref.getInt('user_id')}/reset', {
                              "current_password": oldPassword,
                              "new_password": newPassword,
                              "lang": "${themeColor.getlocal()}",
                              "new_confirmation_password":ConfirmPassword,
                            }).then((value) {
                              if (value != null) {
