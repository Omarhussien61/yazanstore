...
//                 color: Colors.white,
//                 border: Border.symmetric(
//                     vertical: BorderSide(color: Colors.light_grey, width: .5),
//                     horizontal:
//                         BorderSide(color: Colors.light_grey, width: 1))),
//             height: 36,
//             width: MediaQuery.of(context).size.width * .33,
//             child: Center(
//                 child: Container(
...
//                     hintText: localization.translate('search_here'),
//                     hintStyle: TextStyle(
//                         fontSize: 12.0, color: Colors.textfield_grey),
...
//       ),
//       IconButton(
//           icon: Icon(Icons.search, color: Colors.dark_grey),
//           onPressed: () {
...
//                                 style: TextStyle(color: Colors.font_grey),
//                               ),
//                             ),
//                           )
...
//                       side:
//                           new BorderSide(color: Colors.light_grey, width: 2.0),
...
//                     image: _productList[index].photo,
